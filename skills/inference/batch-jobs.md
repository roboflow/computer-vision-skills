...
python skills/inference/assets/poll_batch_job.py JOB_ID  # path should be adjusted to the context, relative location inside skill dir is `assets/poll_batch_job.py`
