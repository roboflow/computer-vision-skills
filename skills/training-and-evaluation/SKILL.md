...
description: Use when training Roboflow models, improving accuracy, or setting up a production feedback loop — covers architecture selection, model IDs, checkpoints, evaluation metrics, the iterative improvement playbook, and Project Deployment Active Learning.
---
...
- `roboflow://skills/training-and-evaluation/active-learning` — production feedback loop: Project Deployment Active Learning, confidence-based sampling, review and retrain cycle
