...
- [data-management](../data-management/SKILL.md) — what to do with the images once mirrored (tags, splits, versions, search)
- [product-navigation](../product-navigation/SKILL.md) — the app's `settings/datasources` page
